...
예시1) option 선택할 때마다 option tag의 text 출력하기
...
예시 2) option 선택할 때마다 option tag의 value attribute 값 출력하기
...
예시 3) submit event 발생 시 event handler에서 선택된 option text 출력하기
